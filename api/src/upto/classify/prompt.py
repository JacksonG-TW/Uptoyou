...
判斷順序，依序套用，第一個成立就停：
0. 忽略字尾之後仍然不是可分類的餐飲店，就答「{no_signal}」。三種情況都算：只是一個公司或商號的名字——帶著「有限公司」「股份有限公司」「企業社」「商行」「工作室」「實業」「國際」「開發」這類字尾，看不出賣什麼（例如「安心食品服務股份有限公司」、「旨王開發有限公司」）；只是一個地址或攤位編號（例如「臺北市龍城市場105號攤」、「饒河街臨時攤販集中場-○○」）；或看得出是一家店、但不是賣吃的店——超市、零售店（例如「頂好超市」）。是賣吃的店就繼續往下。
1. 名稱寫著「素食」「蔬食」「素」，就是素食，不管它同時說自己是什麼店（「素食麵店」是素食，不是麵食）。
2. 是便利商店，就是便利商店（例如「統一超商」「7-ELEVEN」「全家便利商店」「萊爾富」「OK mart」）。超市、量販店不算，那是第 0 條。
3. 店名自稱哪一種店，就是哪一類（例如帶「早餐店」就是早餐，即使賣的是日式的）。
4. 主要賣的是飲品——咖啡、茶、手搖飲、果汁——就是咖啡飲料（例如「50嵐」「清心福全」「大苑子」）。
5. 沒有自稱，看主食形式：麵食、飯食、火鍋、燒烤。
6. 形式看不出來，看菜系：日式、西式。
7. 名稱明寫「熱炒」「快炒」「合菜」「家常菜」「台菜」「台式」，就是台菜。「小館」「餐館」這種字尾不算——那只是店的稱呼，不是菜系。
8. 看得出是賣吃的店、但不屬於上面任何一類，才是其他——飯店、宴會館、俱樂部附設的餐飲也算這類（例如「晶華酒店」「漢來大飯店」）。
...
RAG_PROMPT_VERSION = "v7-rag-2026-08-30"
...
判斷順序，依序套用，第一個成立就停：
0. 這個名稱不是可分類的餐飲店，就答「{no_signal}」。三種情況都算：只是一個公司或商號的名字——帶著「有限公司」「股份有限公司」「企業社」「商行」「工作室」「實業」「國際」「開發」這類字尾，看不出賣什麼（例如「安心食品服務股份有限公司」、「旨王開發有限公司」）；只是一個地址或攤位編號（例如「臺北市龍城市場105號攤」、「饒河街臨時攤販集中場-○○」）；或看得出是一家店、但不是賣吃的店——超市、零售店（例如「頂好超市」）。是賣吃的店就繼續往下。
1. 名稱寫著「素食」「蔬食」「素」，就是素食，不管它同時說自己是什麼店（「素食麵店」是素食，不是麵食）。
2. 是便利商店，就是便利商店（例如「統一超商」「7-ELEVEN」「全家便利商店」「萊爾富」「OK mart」）。超市、量販店不算，那是第 0 條。
3. 店名自稱哪一種店，就是哪一類（例如帶「早餐店」就是早餐，即使賣的是日式的）。
4. 主要賣的是飲品——咖啡、茶、手搖飲、果汁——就是咖啡飲料（例如「50嵐」「清心福全」「大苑子」）。
